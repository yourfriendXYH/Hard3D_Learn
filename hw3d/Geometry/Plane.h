...
{
public:
	static IndexedTriangleList MakeTesselatedTextured(DynamicData::VertexLayout layout, int divisions_x, int divisions_y)
	{
		...
		DynamicData::VerticesBuffer vb{ std::move(layout) };
	...
	{
		using DynamicData::VertexLayout;
		VertexLayout vl;
